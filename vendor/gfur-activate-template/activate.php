    ...
    function template() {
        ...
        <div id="content" class="widecolumn">
            ...
            <?php if ( !$this->has_activation_key() ) {
                ...
                load_template( dirname(__FILE__) . '/' . 'activate-no-key' . '.php' );
                ...
                if ( is_wp_error( $this->result ) ) {
                    load_template( dirname(__FILE__) . '/' . 'activate-error' . '.php' );
                    // get_template_part( $this->template_folder . '/activate', 'error' );

                } else {
                    load_template( dirname(__FILE__) . '/' . 'activate-success' . '.php' );
